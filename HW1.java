public class HW1 {
    ...
    public static void main(String[] args) {
        ...
        String results = course.GetTraversalResults(teamMissionImpossible);
...
class Course {
    ...
    public String GetTraversalResults(Team team){
        String results = "";
        ...
        for (Agent agent : team.agents) {
            ...
            if (coursePassed == true) {
                results += "Participant " + agent.firstname + " " + agent.surname + " successfully traversed the course \n";
            } else {
                results += "Participant " + agent.firstname + " " + agent.surname +" failed to traverse the course \n";
            }
        }
        return results;
    }
